...
[![Release](https://img.shields.io/github/v/release/nathanxiangang-web/CloudSite?include_prereleases&label=release)](https://github.com/nathanxiangang-web/CloudSite/releases/tag/v1.0.0-beta.3)
...
> 当前开发与发布基线：**1.0.0-beta.3**。在线站点：[cloud.netioi.com](https://cloud.netioi.com/)
>
> 发布源码不包含 AList 账号、访问令牌、`.env`、数据库、索引、日志、依赖目录或构建产物。

## 快速入口

- [下载 1.0 Beta](https://github.com/nathanxiangang-web/CloudSite/releases/tag/v1.0.0-beta.3)
...
- `cloudsite-api-v1.0.0-beta.3-linux-amd64.tar.gz`
- `cloudsite-api-v1.0.0-beta.3-linux-arm64.tar.gz`
- `cloudsite-web-v1.0.0-beta.3-linux-amd64.tar.gz`
- `cloudsite-web-v1.0.0-beta.3-linux-arm64.tar.gz`
- `cloudsite-v1.0.0-beta.3-offline-deploy.zip`
- `SHA256SUMS.txt`
...
gzip -dc "cloudsite-api-v1.0.0-beta.3-linux-${arch}.tar.gz" | docker load
gzip -dc "cloudsite-web-v1.0.0-beta.3-linux-${arch}.tar.gz" | docker load
unzip cloudsite-v1.0.0-beta.3-offline-deploy.zip -d CloudSite
cd CloudSite
cp .env.example .env
