...
> **Stable line:** `v1.0.0`  
> **Current development line:** `v2.0.0-alpha.2`  
...
`v2.0.0-alpha.2` is an alpha development release. Use the stable `v1.0.0` line when you do not want development-line changes.
