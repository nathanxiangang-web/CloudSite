...
The current reviewed baseline records **83 exact debt IDs**:
...
| `router_orm_import` | 60 | A legacy router still imports SQLAlchemy, shared ORM models, or the legacy database layer directly. |
