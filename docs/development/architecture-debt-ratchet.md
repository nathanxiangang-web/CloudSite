...
The current reviewed baseline records **0 debt IDs**:
...
| `router_orm_import` | 0 | A legacy router still imports SQLAlchemy, shared ORM models, or the legacy database layer directly. |
