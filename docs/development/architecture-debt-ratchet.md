...
The current reviewed baseline records **58 exact debt IDs**:

| Rule | Baseline | Meaning |
| --- | ---: | --- |
| `module_legacy_import` | 3 | A business module still imports `cloudsite.models`, `cloudsite.database`, `cloudsite.services`, or `cloudsite.main`. |
...
```text
90 -> 88 -> 87 -> 86 -> 85 -> 84 -> 83 -> 82 -> 81 -> 79 -> 76 -> 71 -> 67 -> 59 -> 58 -> ... -> 0
```
