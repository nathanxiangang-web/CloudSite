...
The current reviewed baseline records **6 exact debt IDs**:
...
| `router_orm_import` | 6 | A legacy router still imports SQLAlchemy, shared ORM models, or the legacy database layer directly. |
...
```text
90 -> 88 -> 87 -> 86 -> 85 -> 84 -> 83 -> 82 -> 81 -> 79 -> 76 -> 71 -> 67 -> 59 -> 58 -> 55 -> 52 -> 51 -> 50 -> 49 -> 45 -> 41 -> 39 -> 37 -> 35 -> 33 -> 31 -> 29 -> 27 -> 23 -> 19 -> 17 -> 14 -> 12 -> 10 -> 8 -> 6 -> ... -> 0
```
