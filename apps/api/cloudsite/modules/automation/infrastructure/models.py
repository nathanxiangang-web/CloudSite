...
class CatalogSuggestion(StateBase):
    """Automation-owned advisory Catalog organization suggestion."""
    ...
    applied_revision_id: Mapped[str | None] = mapped_column(
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "suggestion_kind IN "
            "('new_entry', 'new_release', 'asset', "
            "'candidate_duplicate', 'conflict')",
...
__all__ = ["CatalogSuggestion", "ParserCandidateTask", "utcnow"]
