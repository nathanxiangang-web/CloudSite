"""Pure identity fingerprint rules.

This module has no database/framework dependencies and is safe for any business
module to consume through modules.identity.contracts.public.
"""
