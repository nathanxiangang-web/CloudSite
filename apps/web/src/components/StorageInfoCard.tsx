...
export function StorageInfoCard() {
  ...
  if (query.error) return <div className="storage"><small><Cloud size={13} />当前网盘</small><strong title={query.error.message}>状态不可用</strong><button type="button" style={{ minHeight: 28, padding: "0 8px", alignSelf: "flex-start", borderRadius: 7, fontSize: 11 }} onClick={() => query.refetch()}>重试</button></div>;
