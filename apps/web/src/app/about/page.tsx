...
export default function AboutPage() {
  ...
  return <PublicShell><div className="page static-page">
    ...
    <h2>投稿与合作</h2>
    <p>欢迎分享优质软件、图片、视频、文档及其他资源。{site.submission_email && <>投稿邮箱：<a href={`mailto:${site.submission_email}`}>{site.submission_email}</a>。</>}</p>
    <p>也可以前往 <Link href="/submit">资源投稿</Link> 页面生成标准投稿模板。CloudSite 不接收用户直接上传，也不会保存邮箱凭据。</p>
    <p className="static-meta">当前版本 v0.5.1</p>
    <SiteFooter />
  </div></PublicShell>;
}
