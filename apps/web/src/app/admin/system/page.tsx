...
export default function SystemPage() {
  ...
  return <AdminShell title="系统"><div className="admin-page system-grid">
    ...
    <section className="panel"><h2><Server />服务信息</h2><dl><div><dt>API 版本</dt><dd>v{system.data?.version ?? "0.3.1"}</dd></div><div><dt>部署模式</dt><dd>Docker Compose</dd></div><div><dt>健康状态</dt><dd className="ok-text">健康</dd></div><div><dt>时区</dt><dd>{system.data?.timezone ?? "Asia/Shanghai"}</dd></div></dl></section>
  </div>
