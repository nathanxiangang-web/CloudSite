...
> Current development and release baseline: **1.0.0-beta.3**. Live demo: [cloud.netioi.com](https://cloud.netioi.com/)
...
Download CloudSite 1.0.0 Beta 3 and its offline deployment assets from the [GitHub Release](https://github.com/nathanxiangang-web/CloudSite/releases/tag/v1.0.0-beta.3).
